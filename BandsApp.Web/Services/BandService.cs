...
public class BandService
{
    List<Band> bands = new List<Band>
    {
        ...
        new Band { Id = 3, Name = "Amazarashi", Description = "Amazarashi (stylized as amazarashi) is a Japanese rock band from Aomori, currently signed to Sony Music Japan. Formed in 2007, its members are Hiromu Akita (lead vocals, guitar, songwriter) and Manami Toyokawa (keyboard).[1] They have released six singles which have all reached the top 20 of the Oricon charts.", Image = "/Images/Amazarashi.jpg", VideoUrl = "https://www.youtube.com/embed/gB3gUq5A1W0?si=DMOTIBeKVoO3gmGp" }
    };
